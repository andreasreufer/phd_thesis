...
% use cost instead of 
% TODO: SPHLATCHv2 tree with CZ cells
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.6]{27algo_cells.pdf}
\caption{Algorithm to find clumps of particles, which are interconnected as friends of friends.}
\label{ch02_fig25}
\end{center}
\end{figure}
