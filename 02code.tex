...
% TODO: do the index magic
\begin{equation}
\label{ch02_sph02_eq008}
\frac{\partial }{\partial \rv_i} \rho_j =  \frac{\partial \rv_j}{\partial \rv_i} \frac{\partial \rho_j}{\partial \rv_j} = \sum_{k} m_k \nabla W_{jk} ( \delta_{ji} - \delta_{ki})
\end{equation}

So equation \ref{ch02_sph02_eq006} yields
