...
Code performance can now be improved considerably by trying to increase the chances of cache hits. In SPHLATCH v2 this is achieved with different techniques: Most important the data structures for the tree nodes are designed 

Increasing spatial locality in memory accesses 

% access similar particles again (temporal locality)
% reduce cache line usage (spatial locality)
% 
