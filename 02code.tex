...
As mentioned before, the multipole moments can simply be calculated by a recursive post-order algorithm, as shown in figure \ref{ch02_grav02_fig07}.

\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.6]{14algo_multipoles.pdf}
\includegraphics[scale=0.6]{15algo_treedelete.pdf}
\caption{recursive algorithm for Multipole calculation}
...
% setting up next & skip pointer \\
% neighbor search\\
% gravity walk\\
% deleting a tree\\
% implementing trees (pointers)
% tree acceleration: show skip, next and parent pointers by simple tree examples\\
% SPHLATCHv2: cost zone algorithms
