...
Big density contrasts normally arise, when two fluids with different equations of state interact, for example a liquid and a gas in mutual thermal equilibrium. Densities contrasts can easily differ several orders of magnitude. In standard SPH density is a product of particle density and particle mass. So if two fluids with large density differences should be represented in SPH, either the particle densities or the particle masses have to vary considerably.

If all particles have masses in the same order of magnitude, the particle differences 

Classical SPH can represent such a situation in two distinctive ways. 
% TODO: show particles rho vs. r and p vs. r for standard SPH and miscible SPH
