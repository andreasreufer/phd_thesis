...
\sqrt{\frac{\mu}{a^3} } t(\Theta) &=  \frac{1}{2} \Big( \tan{\frac{\Theta}{2}} + \frac{1}{3} \tan{\frac{\Theta}{2}}^3 \Big) \hspace{6.0cm} \text{for~} e = 1\\
a &= \frac{r_p}{e - 1} 
\end{align}
...
r' &= \frac{r_{imp}}{r_0} \\
t_0 &= -\sqrt{\frac{r_0^3}{2 \mu}} \Big( \sqrt{r' (1-r')} + \arccos{r'} \Big)
\end{align}
...
\subsection{Friend-of-friend clump search}
\begin{figure}[htbp]
\begin{center}
