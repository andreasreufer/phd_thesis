...
\begin{equation}
\Big( \frac{d \vv_i }{dt} \Big)_{AV} = \sum_{j} m_j - %\frac{p_j}{\rho_j^2} \sum_{k} \nabla_i W_{jk} ( \delta_{ji} - \delta_{ki})
\end{equation}
...
A disadvantage of this approach is that this viscosity also acts 


 tries to smooth out the shock front by introducing a small artificial viscosity to the fluid, the .
Other approaches 




% TODO: turning off dissipative terms

\subsection{integration}

% TODO: advantages and disadvantages of SPH
