...
At the end of the algorithm the properties of the FOF clumps are determined as in the previous clump searching algorithm. This FOF algorithm is useful for example to find satellites of bodies. Satellites are gravitationally bound to their parent body and are not detected by the 
