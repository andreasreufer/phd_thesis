...
\begin{figure}
\begin{center}
\includegraphics[scale=0.40]{10tree_no_ptr.pdf}
\includegraphics[scale=0.40]{10tree_next_ptr.pdf}
\includegraphics[scale=0.40]{10tree_skip_ptr.pdf}
\caption{The same tables as in \ref{ch02_eos02_fig02} for \emph{dunite}. In the grey zones, ANEOS returns valid pressures and sound speeds, but does not return any particular phase information.}
\label{ch02_eos02_fig04}
\end{center}
\end{figure}
...
% number of pointers, memory requirements
