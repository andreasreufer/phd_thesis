...
\documentclass[xetex,12pt,a4paper,twoside]{report}
...
\usepackage[xetex,
	...
	pdfkeywords={SPH, computational astrophysics, rocket science, collisions}]{hyperref}
...
% afterpage for wrapping text around around landscape pages
...
% short planetary formation intro
\include{01intro}

% all about numerics and SPHLATCH
\include{02code}

% pmc simulations, Lisse stuff, Eriks small body iron enrichment
\include{03ssc} 

% the mars paper
\include{04mars}

% the moon paper & hires simulations, additional plots for alt moon sims
\include{05moon}
