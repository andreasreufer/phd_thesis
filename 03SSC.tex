...
Figures \ref{ch03_fig10a} to \ref{ch03_fig10c} show the $t$-value the central body of the largest remnant as a function of the impact angle. Obviously, the rotation energy increases for higher 

% conclusion: only important for slow & grazing collisions
% not scale dependent because of $W$ term
