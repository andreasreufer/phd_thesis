...
% Largest remnant
%% 
\subsection{Largest remnant mass, accretion efficiency $\xi$, $\vcr$, $Q_D$}
...
\begin{equation}
Q_R = \frac{ \frac{1}{2} \vimp^2 \mu }{\Mtar + \Mimp} ~~~ \mu = \frac{\Mtar \Mimp}{\Mtar + \Mimp} 
\end{equation}
...
\begin{equation}
Q^*_{RD} = q_s R^{9\mu/(3-2\phi)}_{C1} \vimp^{2-3\mu} + q_g R^{3 \mu}_{C1} \vimp^{2-3\mu}
\end{equation}
where $R_{C1}$ is the radius of a body with mass $\Mtot$ and a density of $1 g/cm^3$.
