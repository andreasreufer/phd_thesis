...
\subsection{Catastrophic disruption threshold $Q^*_D$, $Q^*_{RD}$}
...
\end{equation}
where $R_{C1}$ is the radius of a body with mass $\Mtot$ and a density of $1 g/cm^3$. The first part comes from the required energy to overcome material strength, while the second part 


\cite{Stewart:2009p3265} find the
