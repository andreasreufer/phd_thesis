...
\end{center}
\end{figure}
The only problematic cases are when the impactor is slowed down to a velocity too small for an escape and then gets on a highly elliptical orbit with a long orbital time. This is the case for a small part of the parameter space with slow impact velocities and grazing impact angles. Figure shows 


$\big\{ \Mtar, \Mimp, \thimp, \vimp / \vesc \big\}$.
In most cases 
...
\caption{Simulation $\{0.1 \ME, 0.01 \ME, 1.60 \vesc, 38 \deg \}$}
\label{ch03_fig30}
\end{center}
\end{figure}
...
\caption{Number of particles, mean density $\bar{\rho}$ and mean smoothing length $\bar{h}$ for the target and impactor bodies in the \rss simulation set.}
\label{ch03_fig29a}
\end{center}
\end{figure}
...
\caption{Number of particles, mean density $\bar{\rho}$ and mean smoothing length $\bar{h}$ for the target and impactor bodies in the \css simulation set.}
\label{ch03_fig29b}
\end{center}
\end{figure}
...
\caption{Number of particles, mean density $\bar{\rho}$ and mean smoothing length $\bar{h}$ for the target and impactor bodies in the \iss simulation set.}
\label{ch03_fig29c}
\end{center}
\end{figure}
\end{landscape}
