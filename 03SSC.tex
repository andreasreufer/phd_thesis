...
t = \frac{T}{|W|}
\end{align}
The critical value for $t$ can be analytically determined for constant-density bodies and is $t_{crit} = 0.2738$ for McLaurin spheroids \citep{1987gady.book.....B}. Figures \ref{ch03_fig10a} to \ref{ch03_fig10c} show the $t$-value the largest remnant. Note that 


changing the shape of the body does 



 body gains rotation energy which


Above a critical value, the 



Self-gravitating bodies have an upper limit for the angular momentum they can retain. For 


\cite{Canup:2000p3542} gives a critial value for the collision angular momentum of 



 critical ang. momentum\\
