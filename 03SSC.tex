...
Whilst the largest remnant is in most collisions composed mainly from the previous collision target, the impactor often forms a second remnant, when it is not completely accreted. Figures \ref{ch03_fig26a} to \ref{ch03_fig26c} shows 

compare with plot 15 in \cite{Asphaug:2010p3539} \\
