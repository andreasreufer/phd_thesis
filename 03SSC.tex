...
Figures \ref{ch03_fig22a} to \ref{ch03_fig22c} show the difference $\Delta \vartheta = 2 ( \vartheta_{sr} - \vartheta)$. 


calculate the departure of the actual deflection angle from the 
